  ...
  <li className={`Instrument Instrument--${instrumentNum}`}>
    <section className="Instrument__controls">
      ...
      <ul className="Instrument__volume-controls">
        <li><button className="Instrument__mute" onClick={() => muteSound(instrumentNum)}><i className="fa fa-volume-off" aria-hidden="true"></i><span className="Instrument__volume-button-text">Mute</span></button></li>
